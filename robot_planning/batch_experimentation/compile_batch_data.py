...
class BatchDataParser:
    ...
    def parse_datas_list(self):
        batch_code_group = range(10)
        for batch_code in batch_code_group:
            self.parse_datas(batch_code)

    def parse_datas(self, batch_code=None):
        ...
        for run_file in os.listdir(directory):
            ...
            self.collisions.append(run_data["collisions"])
